...
def standardization_preparation (experiment_name,parameter1,parameter2,account_number,experiments_sensors,subset,number_of_experiments,experiments_details,experiment):
    ...
    if hom.Yes_or_No(parameter1) == True :
        ...
        if parameter2 == True:
            ...
            if details == 'account' and number_of_experiments > 1:
